...
ShapeFileURL <- "https://biogeo.ucdavis.edu/data/gadm2.8/shp/RUS_adm_shp.zip"
...
# строим картограмму
spplot(obj = Regions1, 
       zcol = 'NAME_1',              # отображаемая переменная
...
'https://raw.githubusercontent.com/StratGH/Rlub4/data_gks4.csv'
